...
namespace mcq_backend.Migrations
{
    ...
    [Migration("20210614141107_mcq_entities_added")]
    partial class mcq_entities_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mcq_backend.Answer", b =>
                {
            ...
            modelBuilder.Entity("mcq_backend.Game", b =>
                {
            ...
            modelBuilder.Entity("mcq_backend.GameQuestion", b =>
                {
            ...
            modelBuilder.Entity("mcq_backend.History", b =>
                {
            ...
            modelBuilder.Entity("mcq_backend.Lifeline", b =>
                {
            ...
            modelBuilder.Entity("mcq_backend.Question", b =>
                {
                    b.Property<Guid>("QuestionId")
                        .HasColumnType("uuid")
                        .HasColumnName("questionID");
            ...
            modelBuilder.Entity("mcq_backend.ScoreDetail", b =>
                {
                    b.Property<Guid>("ScoreDetailId")
                        .HasColumnType("uuid")
                        .HasColumnName("scoreDetailID");
            ...
            modelBuilder.Entity("mcq_backend.User", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("mcq_backend.Answer", b =>
                {
                    b.HasOne("mcq_backend.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("mcq_backend.GameQuestion", b =>
                {
                    b.HasOne("mcq_backend.Game", "Game")
            ...
            modelBuilder.Entity("mcq_backend.History", b =>
                {
                    ...
                    b.HasOne("mcq_backend.ScoreDetail", "ScoreDetail")
                        .WithMany("Histories")
                        .HasForeignKey("ScoreDetailId")
                        .HasConstraintName("History_scoreDetailID_fkey");

                    b.HasOne("mcq_backend.User", "User")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("mcq_backend.ScoreDetail", b =>
                {
                    b.HasOne("mcq_backend.Game", "Question")
                        .WithMany("ScoreDetails")
                        .HasForeignKey("QuestionId")
                        .HasConstraintName("ScoreDetail_questionID_fkey1");

                    b.HasOne("mcq_backend.Question", "QuestionNavigation")
                        .WithMany("ScoreDetails")
                        .HasForeignKey("QuestionId")
